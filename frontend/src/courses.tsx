    ...
    >
            ...
            {dbLevels.map((level) => {
              ...
              return (
                <div
                  ...
                  className="group relative flex flex-col justify-between p-6 rounded-2xl cursor-pointer bg-white/50 hover:bg-white/75 transition-all duration-700 ease-out hover:scale-[1.028] hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(255,255,255,0.95),0_20px_45px_-6px_rgba(184,124,109,0.3)] overflow-hidden"
                  style={{
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-4">
                      <span 
                        className="px-3.5 py-1 rounded-full text-[10px] font-bold tracking-[0.18em] uppercase text-[#6e4336] flex items-center bg-white/75 border border-[#e8cdc1] shadow-xs"
                        style={{
      ...
      {selectedLevel !== null && activeLevel && (
        <section className="px-6 max-w-[1240px] mx-auto w-full mb-16 animate-in fade-in duration-300">
          ...
          <div 
            className="bg-white/50 border-[1.5px] border-[#e8cdc1] rounded-2xl p-6 md:p-7 mb-8 relative overflow-hidden transition-all duration-300"
            style={{
              ...
              <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-6 flex-wrap">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span 
                      className="px-3.5 py-0.5 rounded-full text-xs font-bold text-[#6e4336] bg-white/75 border border-[#e8cdc1] shadow-xs"
                      style={{ fontFamily: "'Cinzel', serif" }}
                    >
                ...
                <div className="flex items-center flex-wrap gap-2.5 sm:gap-3 text-xs text-[#6e564c] font-medium">
                  <span className="flex items-center gap-1.5 bg-white/75 border border-[#e8cdc1] px-3 py-1.5 rounded-xl shadow-2xs">
          ...
          <div className="space-y-5 w-full">
            {activeLevel.topics.map((topic, topicIdx) => {
              ...
              return (
                <div
                  key={topicKey}
                  className="bg-white/50 border-[1.5px] border-[#e8cdc1] rounded-2xl overflow-hidden transition-all duration-300"
                  style={{
